...
RUN cd rdap-conformance-tool && mvn package -DskipTests && mvn install:install-file -Dfile=./tool/target/rdapct-1.0.3.jar -DgroupId=org.icann -DartifactId=rdap-conformance -Dversion=1.0.3 -Dpackaging=jar
